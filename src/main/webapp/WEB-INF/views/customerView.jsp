		...
		<div class="row">
			...
			<div class="col" style="flex: 1.5;">
				<div class="card">
					...
					<div class="card-body">
						<div class="history" id="content"></div>
						<div class="buttons">
	...
	<script>
		document.getElementById('searchManagerBtn')
				.addEventListener(
						'click',
						function() {
							var managerName = document
									.getElementById('FRST_RGTR_SN').value;
							if (managerName) {
											...
											function() {
												...
												$
														.ajax({
															...
															type : "post",
															data : JSON
																	.stringify(obj), // 객체를 JSON 문자열로 변환하여 전송합니다.
															dataType : "json",
